...
@immutable
class InputPageBlockButtonRow extends InputPageBlock {
  const InputPageBlockButtonRow({
  ...
  /// [align] Horizontal alignment of the buttons; pass null if the buttons must
  /// be shown full-width
  final PageBlockHorizontalAlignment? align;

  static const String constructor = 'inputPageBlockButtonRow';

  static InputPageBlockButtonRow? fromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
  ...
  bool operator ==(Object other) =>
      ...
      (other.runtimeType == runtimeType &&
          other is InputPageBlockButtonRow &&
